...
import ParentPage from '../props/parent_page'
import NetTestPage from '../ui/usage_net'
        ...
        return (
            <View style={styles.container}>
                ...
                <Button
                    ...
                    title={'props'}
                    onPress={() => {
                        this.props.navigation.push('nav5')//push方法 跳转到
                    }}
                />
                <Button
                    style={{ marginTop: 10 }}
                    title={'net'}
                    onPress={() => {
                        this.props.navigation.push('nav6')//push方法 跳转到
                    }}
                />
            </View>
        )
